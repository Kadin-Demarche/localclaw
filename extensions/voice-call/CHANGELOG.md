...
- Version alignment with core LocalClaw release numbers.
...
- First public release of the @localclaw/voice-call plugin.
...
- CLI: `localclaw voicecall` commands (call/start/continue/speak/end/status/tail/expose).
