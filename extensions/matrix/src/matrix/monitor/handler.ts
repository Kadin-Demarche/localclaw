...
export type MatrixMonitorHandlerParams = {
  ...
  core: {
    ...
    channel: (typeof import("localclaw/plugin-sdk"))["channel"];
    system: {
      enqueueSystemEvent: (
        text: string,
  ...
  mentionRegexes: ReturnType<
    (typeof import("localclaw/plugin-sdk"))["channel"]["mentions"]["buildMentionRegexes"]
  >;
              ...
              if (created) {
                ...
                try {
                  await sendMessageMatrix(
                    `room:${roomId}`,
                    [
                      "LocalClaw: access not configured.",
                      "",
                      `Pairing code: ${code}`,
                      "",
