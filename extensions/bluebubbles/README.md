...
This directory contains the **BlueBubbles external channel plugin** for LocalClaw.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `localclaw/plugin-sdk` helpers.
