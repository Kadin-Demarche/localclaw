import type { LineChannelData, LocalClawPluginApi, ReplyPayload } from "localclaw/plugin-sdk";
import {
  createActionCard,
  createImageCard,
  createInfoCard,
...
export function registerLineCardCommand(api: LocalClawPluginApi): void {
  api.registerCommand({
    name: "card",
