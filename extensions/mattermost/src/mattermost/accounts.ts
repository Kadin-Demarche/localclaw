...
export function listMattermostAccountIds(cfg: LocalClawConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: LocalClawConfig): string {
...
export function listEnabledMattermostAccounts(cfg: LocalClawConfig): ResolvedMattermostAccount[] {
