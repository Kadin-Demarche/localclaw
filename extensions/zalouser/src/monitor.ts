import type { LocalClawConfig, MarkdownTableMode, RuntimeEnv } from "localclaw/plugin-sdk";
import type { ChildProcess } from "node:child_process";
import { createReplyPrefixOptions, mergeAllowlist, summarizeMapping } from "localclaw/plugin-sdk";
