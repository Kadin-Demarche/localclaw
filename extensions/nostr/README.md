...
Nostr DM channel plugin for LocalClaw using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to LocalClaw. It enables your bot to:
...
# Configure localclaw to use local relay
