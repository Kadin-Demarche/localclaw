...
declare global {
  interface Window {
    __LOCALCLAW_ASSISTANT_NAME__?: string;
    __LOCALCLAW_ASSISTANT_AVATAR__?: string;
  }
}
...
export function resolveInjectedAssistantIdentity(): AssistantIdentity {
  ...
  return normalizeAssistantIdentity({
    name: window.__LOCALCLAW_ASSISTANT_NAME__,
    avatar: window.__LOCALCLAW_ASSISTANT_AVATAR__,
  });
}
