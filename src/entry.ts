...
function ensureExperimentalWarningSuppressed(): boolean {
  if (isTruthyEnvValue(process.env.LOCALCLAW_NO_RESPAWN)) {
    return false;
  }
  if (isTruthyEnvValue(process.env.LOCALCLAW_NODE_OPTIONS_READY)) {
    return false;
  }
  ...
  process.env.LOCALCLAW_NODE_OPTIONS_READY = "1";
