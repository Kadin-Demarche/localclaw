...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @localclaw/voice-call -> voice-call).
...
export function discoverLocalClawPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".localclaw", "extensions")];
