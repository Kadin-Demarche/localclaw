...
export const normalizePluginsConfig = (
  config?: LocalClawConfig["plugins"],
...
const hasExplicitMemorySlot = (plugins?: LocalClawConfig["plugins"]) =>
  Boolean(plugins?.slots && Object.prototype.hasOwnProperty.call(plugins.slots, "memory"));

const hasExplicitMemoryEntry = (plugins?: LocalClawConfig["plugins"]) =>
  Boolean(plugins?.entries && Object.prototype.hasOwnProperty.call(plugins.entries, "memory-core"));

const hasExplicitPluginConfig = (plugins?: LocalClawConfig["plugins"]) => {
  if (!plugins) {
    return false;
  }
