...
import type { GatewayBindMode, GatewayTailscaleMode, LocalClawConfig } from "../config/config.js";
...
export async function configureGatewayForOnboarding(
  ...
  if (tailscaleMode !== "off" && flow !== "quickstart") {
    await prompter.note(
      [
        "Docs:",
        "https://docs.localclaw.ai/gateway/tailscale",
        "https://docs.localclaw.ai/web",
      ].join("\n"),
      "Tailscale",
    );
