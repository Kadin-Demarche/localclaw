...
function resolveDefaultAccountId(cfg: LocalClawConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: LocalClawConfig): boolean {
...
export function summarizeBindings(cfg: LocalClawConfig, bindings: AgentBinding[]): string[] {
