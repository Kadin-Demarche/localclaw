...
const ensureLocalClawModelsJson = vi.fn().mockResolvedValue(undefined);
const resolveLocalClawAgentDir = vi.fn().mockReturnValue("/tmp/localclaw-agent");
...
vi.mock("../config/config.js", () => ({
  ...
  STATE_DIR: "/tmp/localclaw-state",
  loadConfig,
}));

vi.mock("../agents/models-config.js", () => ({
  ensureLocalClawModelsJson,
}));

vi.mock("../agents/agent-paths.js", () => ({
  resolveLocalClawAgentDir,
}));
