...
function resolveConfiguredModelRaw(cfg: LocalClawConfig): string {
...
function resolveConfiguredModelKeys(cfg: LocalClawConfig): string[] {
...
export function applyPrimaryModel(cfg: LocalClawConfig, model: string): LocalClawConfig {
...
export function applyModelAllowlist(cfg: LocalClawConfig, models: string[]): LocalClawConfig {
  const defaults = cfg.agents?.defaults;
