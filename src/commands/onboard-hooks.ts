...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.localclaw.ai/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("localclaw hooks list")}`,
      `  ${formatCliCommand("localclaw hooks enable <name>")}`,
      `  ${formatCliCommand("localclaw hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
