...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "localclaw-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<LocalClawConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<LocalClawConfig["telegram"]>>,
