...
export async function statusCommand(
  ...
  runtime.log(theme.heading("LocalClaw status"));
  runtime.log("");
  ...
  runtime.log(theme.muted(`Full report: ${formatCliCommand("localclaw security audit")}`));
  runtime.log(theme.muted(`Deep probe: ${formatCliCommand("localclaw security audit --deep")}`));
  ...
  runtime.log("");
  runtime.log("FAQ: https://docs.localclaw.ai/faq");
  runtime.log("Troubleshooting: https://docs.localclaw.ai/troubleshooting");
  runtime.log("");
  ...
  runtime.log(`  Need to share?      ${formatCliCommand("localclaw status --all")}`);
  runtime.log(`  Need to debug live? ${formatCliCommand("localclaw logs --follow")}`);
  if (gatewayReachable) {
    runtime.log(`  Need to test channels? ${formatCliCommand("localclaw status --deep")}`);
  } else {
    runtime.log(`  Fix reachability first: ${formatCliCommand("localclaw gateway probe")}`);
  }
}
