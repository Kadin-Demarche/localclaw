...
export function applyOpencodeZenProviderConfig(cfg: LocalClawConfig): LocalClawConfig {
...
export function applyOpencodeZenConfig(cfg: LocalClawConfig): LocalClawConfig {
