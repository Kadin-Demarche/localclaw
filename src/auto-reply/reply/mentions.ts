...
function resolveMentionPatterns(cfg: LocalClawConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: LocalClawConfig | undefined, agentId?: string): RegExp[] {
