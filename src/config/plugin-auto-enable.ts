import type { LocalClawConfig } from "./config.js";
...
function isTelegramConfigured(cfg: LocalClawConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: LocalClawConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: LocalClawConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: LocalClawConfig): boolean {
...
function isIMessageConfigured(cfg: LocalClawConfig): boolean {
...
function isWhatsAppConfigured(cfg: LocalClawConfig): boolean {
...
function isGenericChannelConfigured(cfg: LocalClawConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: LocalClawConfig): string[] {
  const refs: string[] = [];
...
function isProviderConfigured(cfg: LocalClawConfig, providerId: string): boolean {
...
function isPluginExplicitlyDisabled(cfg: LocalClawConfig, pluginId: string): boolean {
  const entry = cfg.plugins?.entries?.[pluginId];
  return entry?.enabled === false;
}

function isPluginDenied(cfg: LocalClawConfig, pluginId: string): boolean {
...
function ensureAllowlisted(cfg: LocalClawConfig, pluginId: string): LocalClawConfig {
...
function enablePluginEntry(cfg: LocalClawConfig, pluginId: string): LocalClawConfig {
  const entries = {
    ...cfg.plugins?.entries,
    [pluginId]: {
