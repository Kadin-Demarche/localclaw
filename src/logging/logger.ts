...
export const DEFAULT_LOG_DIR = "/tmp/localclaw";
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "localclaw.log"); // legacy single-file path

const LOG_PREFIX = "localclaw";
...
function resolveSettings(): ResolvedSettings {
  let cfg: LocalClawConfig["logging"] | undefined =
    (loggingState.overrideSettings as LoggerSettings | null) ?? readLoggingConfig();
  if (!cfg) {
    try {
      const loaded = requireConfig("../config/config.js") as {
        loadConfig?: () => LocalClawConfig;
      };
