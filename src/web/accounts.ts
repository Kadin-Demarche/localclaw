...
function listConfiguredAccountIds(cfg: LocalClawConfig): string[] {
...
export function listWhatsAppAuthDirs(cfg: LocalClawConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: LocalClawConfig): boolean {
  return listWhatsAppAuthDirs(cfg).some((authDir) => hasWebCredsSync(authDir));
}

export function listWhatsAppAccountIds(cfg: LocalClawConfig): string[] {
...
export function resolveDefaultWhatsAppAccountId(cfg: LocalClawConfig): string {
...
export function resolveWhatsAppAuthDir(params: { cfg: LocalClawConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: LocalClawConfig): ResolvedWhatsAppAccount[] {
