...
export function listSignalAccountIds(cfg: LocalClawConfig): string[] {
...
export function resolveDefaultSignalAccountId(cfg: LocalClawConfig): string {
...
function mergeSignalAccountConfig(cfg: LocalClawConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: LocalClawConfig): ResolvedSignalAccount[] {
