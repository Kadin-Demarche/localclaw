...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveLocalClawAgentDir() returns mainAgentDir
    process.env.LOCALCLAW_STATE_DIR = tmpDir;
    process.env.LOCALCLAW_AGENT_DIR = mainAgentDir;
