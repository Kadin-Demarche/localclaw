...
describe("Agent-specific tool filtering", () => {
    ...
    const cfg: LocalClawConfig = {
      ...
      agents: {
        list: [
          {
            id: "restricted",
            workspace: "~/localclaw-restricted",
            tools: {
  ...
  it("should allow different tool policies for different agents", () => {
    ...
    const mainTools = createLocalClawCodingTools({
      config: cfg,
      sessionKey: "agent:main:main",
    ...
    const familyTools = createLocalClawCodingTools({
      config: cfg,
  ...
  it("should apply group tool policy overrides (group-specific beats wildcard)", () => {
    ...
    const trustedTools = createLocalClawCodingTools({
      config: cfg,
  ...
  it("should apply per-sender tool policies for group tools", () => {
    ...
    const aliceTools = createLocalClawCodingTools({
      config: cfg,
    ...
    const bobTools = createLocalClawCodingTools({
      config: cfg,
      sessionKey: "agent:main:whatsapp:group:family",
      senderId: "bob",
  ...
  it("should not let default sender policy override group tools", () => {
    ...
    const adminTools = createLocalClawCodingTools({
      config: cfg,
