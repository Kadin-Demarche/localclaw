...
function resolveAvatarSource(cfg: LocalClawConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: LocalClawConfig, agentId: string): AgentAvatarResolution {
