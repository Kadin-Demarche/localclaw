  ...
  it("includes hardening and resource flags", () => {
    ...
    expect(args).toEqual(
      expect.arrayContaining([
        ...
        "localclaw.sandbox=1",
        "--label",
        "localclaw.sessionKey=main",
        "--label",
        "localclaw.createdAtMs=1700000000000",
        "--label",
        "localclaw.sandboxBrowser=1",
        "--read-only",
        "--tmpfs",
        "/tmp",
        "--network",
