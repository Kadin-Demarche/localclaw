...
describe("createLocalClawCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createLocalClawCodingTools({
      config,
    ...
    const anthropicTools = createLocalClawCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createLocalClawCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createLocalClawCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
