...
function resolveExecConfig(cfg: LocalClawConfig | undefined) {
...
export function createLocalClawCodingTools(options?: {
  ...
  const base = (codingTools as unknown as AnyAgentTool[]).flatMap((tool) => {
    if (tool.name === readTool.name) {
      ...
      return [createLocalClawReadTool(freshReadTool)];
    }
