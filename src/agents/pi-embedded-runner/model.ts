...
// pi-ai's built-in Anthropic catalog can lag behind LocalClaw's defaults/docs.
...
export function buildModelAliasLines(cfg?: LocalClawConfig) {
...
export function resolveModel(
  ...
  const resolvedAgentDir = agentDir ?? resolveLocalClawAgentDir();
