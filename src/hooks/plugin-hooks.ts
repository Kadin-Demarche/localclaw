...
import type { LocalClawPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: LocalClawPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: LocalClawPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
