...
export type ChannelAgentToolFactory = (params: { cfg?: LocalClawConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: LocalClawConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: LocalClawConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: LocalClawConfig }) => boolean;
  supportsCards?: (params: { cfg: LocalClawConfig }) => boolean;
