...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof LocalClawConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: LocalClawConfig; env: NodeJS.ProcessEnv }): {
  cfg: LocalClawConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
