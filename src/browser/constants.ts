export const DEFAULT_LOCALCLAW_BROWSER_ENABLED = true;
export const DEFAULT_BROWSER_EVALUATE_ENABLED = true;
export const DEFAULT_LOCALCLAW_BROWSER_COLOR = "#FF4500";
export const DEFAULT_LOCALCLAW_BROWSER_PROFILE_NAME = "localclaw";
