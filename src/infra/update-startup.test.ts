...
describe("update-startup", () => {
  ...
  beforeEach(async () => {
    ...
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "localclaw-update-check-"));
  ...
  it("logs update hint for npm installs when newer tag exists", async () => {
    const { resolveLocalClawPackageRoot } = await import("./localclaw-root.js");
    ...
    vi.mocked(resolveLocalClawPackageRoot).mockResolvedValue("/opt/localclaw");
