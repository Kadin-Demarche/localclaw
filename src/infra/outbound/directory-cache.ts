...
export class DirectoryCache<T> {
  ...
  private lastConfigRef: LocalClawConfig | null = null;

  constructor(private readonly ttlMs: number) {}

  get(key: string, cfg: LocalClawConfig): T | undefined {
  ...
  set(key: string, value: T, cfg: LocalClawConfig): void {
    this.resetIfConfigChanged(cfg);
  ...
  clear(cfg?: LocalClawConfig): void {
    this.cache.clear();
    if (cfg) {
  ...
  private resetIfConfigChanged(cfg: LocalClawConfig): void {
