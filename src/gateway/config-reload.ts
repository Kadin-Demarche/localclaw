...
import type { LocalClawConfig, ConfigFileSnapshot, GatewayReloadMode } from "../config/config.js";
...
export function resolveGatewayReloadSettings(cfg: LocalClawConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  initialConfig: LocalClawConfig;
  readSnapshot: () => Promise<ConfigFileSnapshot>;
  onHotReload: (plan: GatewayReloadPlan, nextConfig: LocalClawConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: LocalClawConfig) => void;
  log: {
