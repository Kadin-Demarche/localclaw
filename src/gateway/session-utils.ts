...
import { type LocalClawConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: LocalClawConfig): string[] {
...
export function listAgentsForGateway(cfg: LocalClawConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: LocalClawConfig): string {
...
function resolveSessionStoreAgentId(cfg: LocalClawConfig, canonicalKey: string): string {
...
export function resolveGatewaySessionStoreTarget(params: { cfg: LocalClawConfig; key: string }): {
  agentId: string;
  storePath: string;
  canonicalKey: string;
  storeKeys: string[];
...
export function loadCombinedSessionStoreForGateway(cfg: LocalClawConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: LocalClawConfig): GatewaySessionsDefaults {
