...
export const A2UI_PATH = "/__localclaw__/a2ui";

export const CANVAS_HOST_PATH = "/__localclaw__/canvas";

export const CANVAS_WS_PATH = "/__localclaw__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.localclawCanvasA2UIAction.postMessage(...)
  // - Android: window.localclawCanvasA2UIAction.postMessage(...)
  const handlerNames = ["localclawCanvasA2UIAction"];
  ...
  globalThis.LocalClaw = globalThis.LocalClaw ?? {};
  globalThis.LocalClaw.postMessage = postToNode;
  globalThis.LocalClaw.sendUserAction = sendUserAction;
  globalThis.localclawPostMessage = postToNode;
  globalThis.localclawSendUserAction = sendUserAction;
