...
LocalClaw treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.localclaw/settings/voicewake.json`

Shape:

```json
{ "triggers": ["localclaw", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
