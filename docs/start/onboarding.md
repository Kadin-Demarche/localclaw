---
summary: "First-run onboarding flow for LocalClaw (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give LocalClaw">
...
<Step title="CLI">
  ...
  The app can install the global `localclaw` CLI via npm/pnpm so terminal
