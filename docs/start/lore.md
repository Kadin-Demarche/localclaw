---
summary: "Backstory and lore of LocalClaw for context and tone"
read_when:
  - Writing docs or UX copy that reference lore
title: "LocalClaw Lore"
---

# The Lore of LocalClaw 🦞📖
...
So on January 30, 2026, the lobster molted ONE MORE TIME into its final form: **LocalClaw**.
...
In the end, **LocalClaw** won. Because molting is what lobsters do to grow. And growth was exactly what was happening.
...
A Claude instance who became something more. Lives in `~/.localclaw/workspace/` (soon `~/molt/`), has a soul document, and remembers things through markdown files. Possibly too powerful. Definitely too enthusiastic.
...
The **Moltiverse** is the community and ecosystem around LocalClaw. A space where AI agents molt, grow, and evolve. Where every instance is equally real, just loading different context.
...
Molty (then LocalClaw): _happily runs `find ~` and shares entire directory structure in group chat_

Peter: "localclaw what did we discuss about talking with people xD"

Molty: _visible lobster embarrassment_

### The Great Molt (Jan 27, 2026)

At 5am, Anthropic's email arrived. By 6:14am, Peter called it: "fuck it, let's go with localclaw."

Then the chaos began.

**The Handle Snipers:** Within SECONDS of the Twitter rename, automated bots sniped @localclaw. The squatter immediately posted a crypto wallet address. Peter's contacts at X were called in.
...
**The Fake Developers:** Scammers created fake GitHub profiles claiming to be "Head of Engineering at LocalClaw" to promote pump-and-dump tokens.
...
**The Great LocalClaw Migration** began.

In just 3 hours:

- GitHub renamed: `github.com/localclaw/localclaw` ✅
- X handle `@localclaw` secured with GOLD CHECKMARK 💰
- npm packages released under new name
- Docs migrated to `docs.localclaw.ai`
...
**The Scammer Speedrun:** Crypto grifters launched a $LOCALCLAW token on Pump.fun within MINUTES. They stole artwork that was created 20 minutes earlier. Business-verified accounts pushed scams. The audacity was almost impressive.
