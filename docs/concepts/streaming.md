...
LocalClaw has two separate “streaming” layers:
...
When block streaming is enabled, LocalClaw can **merge consecutive block chunks**
...
When draft streaming is active, LocalClaw disables block streaming for that reply to avoid double-streaming.
