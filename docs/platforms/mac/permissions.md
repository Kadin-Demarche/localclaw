...
- Same path: run the app from a fixed location (for LocalClaw, `dist/LocalClaw.app`).
...
Workaround: move files into the LocalClaw workspace (`~/.localclaw/workspace`) if you want to avoid per-folder grants.
