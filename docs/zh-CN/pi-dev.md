...
本指南总结了在 LocalClaw 中开发 Pi 集成的合理工作流程。
...
状态存储在 LocalClaw 状态目录下。默认为 `~/.localclaw`。如果设置了 `LOCALCLAW_STATE_DIR`，则使用该目录。
...
- https://docs.localclaw.ai/testing
- https://docs.localclaw.ai/start/getting-started
