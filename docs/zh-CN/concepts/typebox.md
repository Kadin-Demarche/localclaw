...
- 生成的 Swift 模型：`apps/macos/Sources/LocalClawProtocol/GatewayModels.swift`
...
- https://raw.githubusercontent.com/localclaw/localclaw/main/dist/protocol.schema.json
