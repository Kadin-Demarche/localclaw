...
read_when:
  - You are building a LocalClaw plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (localclaw.plugin.json)

Every plugin **must** ship a `localclaw.plugin.json` file in the **plugin root**.
LocalClaw uses this manifest to validate configuration **without executing plugin
