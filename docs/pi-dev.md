...
This guide summarizes a sane workflow for working on the pi integration in LocalClaw.
...
- Trigger the agent directly:
  - `pnpm localclaw agent --message "Hello" --thinking low`
...
State lives under the LocalClaw state directory. Default is `~/.localclaw`. If `LOCALCLAW_STATE_DIR` is set, use that directory instead.

To reset everything:

- `localclaw.json` for config
...
- [https://docs.localclaw.ai/testing](https://docs.localclaw.ai/testing)
- [https://docs.localclaw.ai/start/getting-started](https://docs.localclaw.ai/start/getting-started)
