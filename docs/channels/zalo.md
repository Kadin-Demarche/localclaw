...
- Install via CLI: `localclaw plugins install @localclaw/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `localclaw plugins install ./extensions/zalo`
   - From npm (if published): `localclaw plugins install @localclaw/zalo`
...
- Approve via:
  - `localclaw pairing list zalo`
  - `localclaw pairing approve zalo <CODE>`
...
- Example: `localclaw message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `localclaw channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `localclaw logs --follow`
