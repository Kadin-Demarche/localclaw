...
read_when:
  - You want LocalClaw to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables LocalClaw to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- The onboarding wizard (`localclaw onboard`) and `localclaw channels add` list optional channel plugins.
...
```bash
localclaw plugins install @localclaw/nostr
```

Use a local checkout (dev workflows):

```bash
localclaw plugins install --link <path-to-localclaw>/extensions/nostr
```
...
```json
{
  "channels": {
    "nostr": {
      ...
      "profile": {
        "name": "localclaw",
        "displayName": "LocalClaw",
        "about": "Personal assistant DM bot",
        "picture": "https://example.com/avatar.png",
        "banner": "https://example.com/banner.png",
        "website": "https://example.com",
        "nip05": "localclaw@example.com",
        "lud16": "localclaw@example.com"
      }
    }
  }
}
