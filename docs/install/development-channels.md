...
LocalClaw ships three update channels:
...
When you **explicitly** switch channels with `--channel`, LocalClaw also aligns
the install method:
...
When you switch channels with `localclaw update`, LocalClaw also syncs plugin sources:
