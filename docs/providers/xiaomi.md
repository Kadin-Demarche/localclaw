---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with LocalClaw"
read_when:
  - You want Xiaomi MiMo models in LocalClaw
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). LocalClaw uses
