...
You can point LocalClaw at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or LocalClaw
...
- [Anthropic provider](/providers/anthropic) - Native LocalClaw integration with Claude setup-token or API keys
