---
summary: "Use Qwen OAuth (free tier) in LocalClaw"
read_when:
  - You want to use Qwen with LocalClaw
...
If you already logged in with the Qwen Code CLI, LocalClaw will sync credentials
