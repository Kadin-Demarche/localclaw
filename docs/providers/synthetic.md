---
summary: "Use Synthetic's Anthropic-compatible API in LocalClaw"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. LocalClaw registers it as the
...
Note: LocalClaw's Anthropic client appends `/v1` to the base URL, so use
