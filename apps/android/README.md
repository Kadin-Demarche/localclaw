## LocalClaw Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_localclaw-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm localclaw gateway --port 18789 --verbose
```
