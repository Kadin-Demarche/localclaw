package ai.localclaw.android.ui
...
import ai.localclaw.android.LocationMode
import ai.localclaw.android.MainViewModel
import ai.localclaw.android.NodeForegroundService
import ai.localclaw.android.VoiceWakeMode
import ai.localclaw.android.WakeWords
  ...
  LazyColumn(
      ...
      AnimatedVisibility(visible = voiceWakeMode != VoiceWakeMode.Off) {
        Column(verticalArrangement = Arrangement.spacedBy(6.dp), modifier = Modifier.fillMaxWidth()) {
          ListItem(
            ...
            supportingContent = { Text("Listens only while LocalClaw is open.") },
            trailingContent = {
              RadioButton(
    ...
    item {
      Column(verticalArrangement = Arrangement.spacedBy(6.dp), modifier = Modifier.fillMaxWidth()) {
        ...
        ListItem(
          ...
          supportingContent = { Text("Only while LocalClaw is open.") },
          trailingContent = {
            RadioButton(
    ...
    item {
      ListItem(
        ...
        supportingContent = { Text("Keeps the screen awake while LocalClaw is open.") },
