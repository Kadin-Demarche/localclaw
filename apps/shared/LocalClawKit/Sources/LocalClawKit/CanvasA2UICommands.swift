...
public enum LocalClawCanvasA2UICommand: String, Codable, Sendable {
...
public struct LocalClawCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct LocalClawCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
