...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.localclaw", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.localclaw", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: LocalClawProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
