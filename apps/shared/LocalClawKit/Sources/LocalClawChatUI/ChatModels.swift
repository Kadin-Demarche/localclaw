...
public typealias LocalClawPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias LocalClawPlatformImage = UIImage
#endif

public struct LocalClawChatUsageCost: Codable, Hashable, Sendable {
...
public struct LocalClawChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: LocalClawChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(LocalClawChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct LocalClawChatMessageContent: Codable, Hashable, Sendable {
...
public struct LocalClawChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [LocalClawChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: LocalClawChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [LocalClawChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: LocalClawChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(LocalClawChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([LocalClawChatMessageContent].self, forKey: .content) {
...
public struct LocalClawChatHistoryPayload: Codable, Sendable {
...
public struct LocalClawSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct LocalClawSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [LocalClawSessionPreviewItem]
}

public struct LocalClawSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [LocalClawSessionPreviewEntry]

    public init(ts: Int, previews: [LocalClawSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct LocalClawChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct LocalClawChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct LocalClawAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct LocalClawChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct LocalClawGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct LocalClawPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: LocalClawPlatformImage?
    ...
    public init(
        ...
        mimeType: String,
        type: String = "file",
        preview: LocalClawPlatformImage?)
    {
        self.url = url
        self.data = data
        self.fileName = fileName
...
public struct LocalClawChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
