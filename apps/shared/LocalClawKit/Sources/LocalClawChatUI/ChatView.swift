...
@MainActor
public struct LocalClawChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: LocalClawChatViewModel
    ...
    public init(
        viewModel: LocalClawChatViewModel,
    ...
    private var visibleMessages: [LocalClawChatMessage] {
        let base: [LocalClawChatMessage]
    ...
    private func mergeToolResults(in messages: [LocalClawChatMessage]) -> [LocalClawChatMessage] {
        ...
        for message in messages {
            ...
            let merged = LocalClawChatMessage(
                id: last.id,
                role: last.role,
                content: content,
    ...
    private func isToolResultMessage(_ message: LocalClawChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: LocalClawChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: LocalClawChatMessage) -> String {
