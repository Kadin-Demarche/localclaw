...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = LocalClawChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = LocalClawChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
