...
final class ScreenController {
    ...
    /// Callback invoked when an localclaw:// deep link is tapped in the canvas
    ...
    private static func bundledResourceURL(
        ...
        -> URL?
    {
        let bundle = LocalClawKitResources.bundle
...
/// Handles navigation policy to intercept localclaw:// deep links from canvas
@MainActor
private final class ScreenNavigationDelegate: NSObject, WKNavigationDelegate {
        ...
        decisionHandler: @escaping @MainActor @Sendable (WKNavigationActionPolicy) -> Void)
    {
        ...
        // Intercept localclaw:// deep links.
        if url.scheme?.lowercased() == "localclaw" {
