...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.localclaw", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return LocalClawConfigFile.defaultWorkspaceURL() }
