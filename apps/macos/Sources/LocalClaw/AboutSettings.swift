...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/localclaw/localclaw") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/localclaw/localclaw")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://localclaw.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
                (Bundle.main.object(forInfoDictionaryKey: "LocalClawBuildTimestamp") as? String) ??
                (Bundle.main.object(forInfoDictionaryKey: "LocalClawBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "LocalClawGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "LocalClawGitCommit") as? String) ??
            "unknown"
    }
