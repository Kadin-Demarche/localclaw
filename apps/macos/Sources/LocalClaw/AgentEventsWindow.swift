...
private struct EventRow: View {
    ...
    private func prettyJSON(_ dict: [String: LocalClawProtocol.AnyCodable]) -> String? {
...
struct AgentEventsWindow_Previews: PreviewProvider {
    static var previews: some View {
        let sample = ControlAgentEvent(
            ...
            data: [
                "phase": LocalClawProtocol.AnyCodable("start"),
                "name": LocalClawProtocol.AnyCodable("bash"),
            ],
            summary: nil)
