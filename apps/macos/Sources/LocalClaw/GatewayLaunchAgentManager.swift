...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.localclaw", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".localclaw/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.localclawCommand(
            subcommand: "gateway",
