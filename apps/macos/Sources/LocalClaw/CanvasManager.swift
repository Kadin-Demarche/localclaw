...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.localclaw", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("LocalClaw/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__localclaw__/a2ui/").absoluteString + "?platform=macos"
    }
