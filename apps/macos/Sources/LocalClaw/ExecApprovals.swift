...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.localclaw", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        LocalClawPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        LocalClawPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
