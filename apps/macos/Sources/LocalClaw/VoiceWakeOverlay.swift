...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.localclaw", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other LocalClaw windows, but below the system’s pop-up menus.
