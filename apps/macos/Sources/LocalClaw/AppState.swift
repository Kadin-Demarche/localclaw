...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = LocalClawConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = LocalClawConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = LocalClawConfigFile.loadDict()
            ...
            LocalClawConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/localclaw"
        state.remoteCliPath = ""
        return state
    }
}
