...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .localclawSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? LocalClawPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? LocalClawPaths.stateDirURL.path
...
extension Notification.Name {
    static let localclawSelectSettingsTab = Notification.Name("localclawSelectSettingsTab")
}
