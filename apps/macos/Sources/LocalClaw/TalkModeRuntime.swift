...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.localclaw", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.localclaw", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [LocalClawChatMessage] = messages.compactMap { item in
