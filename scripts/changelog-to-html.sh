...
if [[ -z "$version_content" ]]; then
  echo "<h2>LocalClaw $VERSION</h2>"
  echo "<p>Latest LocalClaw update.</p>"
  echo "<p><a href=\"https://github.com/localclaw/localclaw/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
