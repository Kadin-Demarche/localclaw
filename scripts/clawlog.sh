...
show_usage() {
    cat << EOF
clawlog - LocalClaw Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View LocalClaw logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    LocalClaw logs flow through the macOS unified log (subsystem: ai.localclaw).
