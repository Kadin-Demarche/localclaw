...
func NewPiTranslator(srcLang, tgtLang string, glossary []GlossaryEntry, thinking string) (*PiTranslator, error) {
	...
	options.AppName = "localclaw-docs-i18n"
	options.WorkDir = "/tmp"
...
- Keep product names in English: LocalClaw, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the LocalClaw Gateway, use “Gateway 网关”.
