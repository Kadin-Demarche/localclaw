...
# Output:
# - dist/LocalClaw.app
# - dist/LocalClaw-<version>.zip
# - dist/LocalClaw-<version>.dmg
...
APP="$ROOT_DIR/dist/LocalClaw.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/LocalClaw-$VERSION.zip"
DMG="$ROOT_DIR/dist/LocalClaw-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/LocalClaw-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/LocalClaw-$VERSION.dSYM.zip"
